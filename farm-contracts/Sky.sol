...
contract NativeToken is BEP20 {
    ...
    uint256 public constant maxSupply = 5_000_000e18; // 5_000_000e18 == 5 000 000

    constructor() BEP20('Sky Whales Token', 'SKY') {
        _mint(msg.sender, 300_000e16); // 300_000e16 == 3,000
    }

    /// @notice Creates `_amount` token to token address. Must only be called by the owner (MasterWhale).
